...
class TenantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tenant
        fields = [
            'id', 'name', 'slug', 'schema_name', 'tier', 'trial_ends_at',
            'max_users', 'max_warehouses', 'max_branches', 'storage_limit_mb',
            'enabled_modules', 'email', 'phone', 'address', 'country', 'timezone',
            'logo_url', 'primary_color', 'created_at', 'updated_at', 'usage', 'domains',
        ]
...
class TenantUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TenantUser
        fields = ['id', 'email', 'first_name', 'last_name', 'phone', 'tenants',
                  'current_tenant', 'profile_photo', 'language', 'time_zone', 'date_joined']
