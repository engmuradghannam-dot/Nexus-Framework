...
class Lead(models.Model):
    STATUS_CHOICES = [('Open', 'Open'), ('Replied', 'Replied'), ('Opportunity', 'Opportunity'), ('Quotation', 'Quotation'), ('Lost', 'Lost'), ('Converted', 'Converted')]
...
class Opportunity(models.Model):
    STATUS_CHOICES = [('Open', 'Open'), ('Quotation', 'Quotation'), ('Converted', 'Converted'), ('Lost', 'Lost')]
