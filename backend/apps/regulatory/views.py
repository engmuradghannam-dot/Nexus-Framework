...
from .serializers import RegulationSerializer, ComplianceCheckSerializer, RiskSerializer


class RegulationViewSet(viewsets.ModelViewSet):
    queryset = Regulation.objects.select_related('created_by').prefetch_related('compliance_checks', 'risks')
    ...
    def dashboard(self, request):
        ...
        compliance_rate = round((avg_compliance / total_checks) * 100, 2) if total_checks else 0
