...
from .serializers import (
    IndustryVerticalSerializer, VerticalTemplateSerializer,
    CompanySerializer, CompanyListSerializer, SectorSerializer, MetricSerializer
)
...
class CompanyViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Company.objects.select_related('industry_vertical').prefetch_related('metrics')
...
class SectorViewSet(viewsets.ModelViewSet):
    queryset = Sector.objects.select_related('industry_vertical').prefetch_related('sub_sectors')
