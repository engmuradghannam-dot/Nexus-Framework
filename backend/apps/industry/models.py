...
class IndustryVertical(models.Model):
    ...
    report_templates = models.JSONField(
        default=list,
        help_text="Available report templates for this vertical"
    )
    ...
    compliance_frameworks = models.JSONField(
        default=list,
        help_text="e.g. ['ISO9001', 'GDPR', 'HIPAA']"
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True, related_name='created_verticals'
    )
...
class VerticalTemplate(models.Model):
    ...
    vertical_type = models.CharField(max_length=50, choices=[
...
class Company(models.Model):
    ...
    industry_vertical = models.ForeignKey(
        IndustryVertical, on_delete=models.PROTECT,
...
class Sector(models.Model):
    ...
    industry_vertical = models.ForeignKey(
        IndustryVertical, on_delete=models.CASCADE,
