...
class IndustryVerticalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'modules_enabled', 'features_config', 'report_templates',
            'default_currency', 'supported_currencies',
            'multi_branch_enabled', 'multi_warehouse_enabled',
            'compliance_frameworks',
            'module_count', 'feature_count', 'company_count',
...
class VerticalTemplateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'id', 'name', 'vertical_type', 'description',
            'default_modules', 'default_features', 'default_reports',
            'default_compliance', 'is_active', 'created_at'
        ]
...
class SectorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Sector
        fields = [
            'id', 'name', 'code', 'industry_vertical', 'industry_vertical_name',
            'description', 'parent_sector', 'is_active', 'created_at'
        ]
...
class CompanySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'ticker',
            'industry_vertical', 'industry_vertical_name',
            'sector', 'sector_name',
            'custom_modules', 'custom_features',
            'market_cap', 'revenue', 'employees',
            'headquarters', 'website',
            'currency', 'multi_branch_enabled', 'multi_warehouse_enabled',
            'effective_modules', 'effective_features', 'available_reports',
            'is_active', 'created_at', 'updated_at'
        ]
...
class CompanyListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Company
        fields = [
            'id', 'name', 'ticker', 'industry_vertical', 'industry_vertical_name',
...
class MetricSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Metric
        fields = [
            'id', 'company', 'company_name', 'name', 'metric_type',
