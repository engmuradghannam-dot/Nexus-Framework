...
from .serializers import (
    UserSerializer, CompanyProfileSerializer, CompanyProfileListSerializer,
...
class CompanyProfileViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = CompanyProfile.objects.select_related('industry_vertical').prefetch_related('branches')
...
class BranchViewSet(viewsets.ModelViewSet):
    queryset = Branch.objects.select_related('company', 'manager').prefetch_related('warehouses')
...
class WarehouseViewSet(viewsets.ModelViewSet):
    queryset = Warehouse.objects.select_related('branch', 'parent_warehouse').prefetch_related('sub_warehouses')
