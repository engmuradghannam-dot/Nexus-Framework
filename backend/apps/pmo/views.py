...
class ProjectViewSet(viewsets.ModelViewSet):
    queryset = Project.objects.select_related('owner', 'branch').prefetch_related('tasks', 'milestones')
    ...
    def dashboard(self, request):
        ...
        return Response({
            ...
            'budget_utilization': round((total_spent / total_budget) * 100, 2) if total_budget else 0,
        })
