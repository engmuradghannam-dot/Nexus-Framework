...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'project', 'project_name', 'title', 'description',
                  'assignee', 'assignee_name', 'status', 'due_date',
...
class MilestoneSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Milestone
        fields = ['id', 'project', 'name', 'target_date', 'achieved_date',
                  'description', 'is_achieved', 'is_overdue']
...
class ProjectSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Project
        fields = ['id', 'name', 'code', 'description', 'status', 'priority',
                  'owner', 'owner_name', 'start_date', 'end_date',
                  'budget', 'spent', 'budget_utilization', 'progress',
                  'is_overdue', 'branch', 'branch_name',
                  'task_count', 'completed_tasks', 'milestone_count',
