...
from .serializers import AIModelSerializer, InsightSerializer, PredictionSerializer


class AIModelViewSet(viewsets.ModelViewSet):
    queryset = AIModel.objects.select_related("owner").prefetch_related(
    ...
    def dashboard(self, request):
        ...
        avg_accuracy = (
            AIModel.objects.filter(accuracy__gt=0).aggregate(avg=Avg("accuracy"))[
                "avg"
            ]
            or 0
        )
