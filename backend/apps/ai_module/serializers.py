...
class PredictionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Prediction
        fields = ['id', 'model', 'model_name', 'input_data', 'output_data',
...
class InsightSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'severity',
                  'source_model', 'model_name', 'related_project', 'project_name',
                  'is_read', 'created_at']
...
class AIModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIModel
        fields = ['id', 'name', 'version', 'model_type', 'status',
                  'description', 'accuracy', 'f1_score', 'training_data_size',
                  'last_trained', 'deployed_at', 'owner', 'owner_name',
                  'prediction_count', 'insight_count',
